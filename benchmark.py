        ...
        for run_number in range(args.runs):
            ...
            for prompt_idx, prompt in enumerate(args.prompts):
                ...
                with Live(layout, console=console, refresh_per_second=10, screen=True) as live:
                    ...
                    header.append(f"{tests_completed + 1}/{total_tests} ({progress_percent}%)", style="white")
                    header.append(" - ", style="white")
                    ...
                    try:
                        ...
                        for chunk in stream:
                            ...
                            if hasattr(chunk.message, 'content'):
                                ...
                                output_content.append(f"{tests_completed + 1}/{total_tests} ({progress_percent}%)", style="white")
                                output_content.append(" - ", style="white")
